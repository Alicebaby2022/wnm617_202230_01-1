...
[
  '{{repeat(50)}}',
  {
    ...
    type: '{{random("rabbit","chicken","raccoon","hedgehog")}}',
    breed: function(tags) {
      var breeds = {
        rabbit:["holland lop","mini lop","lionhead"],
        chicken:["leghorn","ancona","barnevelder"],
        raccoon:["lotor","cancrivorus","pygmaeus"],
        hedgehog:["somali","amur","hugh’s"]
      };
...
[
  '{{repeat(250)}}',
  {
    ...
    lat: '{{floating( 37.803682, 37.710480)}}',
    lng: '{{floating(-122.505969, -122.340323)}}',
